...
hi Statement    ctermbg=None ctermfg=254  cterm=Bold
hi PreProc      ctermbg=None ctermfg=254  cterm=Bold
hi Type         ctermbg=None ctermfg=254  cterm=Bold
hi Special      ctermbg=None ctermfg=None cterm=None
hi Underlined   ctermbg=None ctermfg=None cterm=Underline
hi Ignore       ctermbg=None ctermfg=None cterm=None
hi Error        ctermbg=160  ctermfg=None cterm=None
